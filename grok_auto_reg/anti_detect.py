...
def get_random_user_agent() -> str:
    """Get a random Chromium User-Agent from the curated catalog in user_agents.py."""
...
def random_typing_delay(min_delay: float = 0.012, max_delay: float = 0.045):
    """Simulate human typing speed between keystrokes with configurable speed."""
...
if __name__ == "__main__":
    ...
    print(f"User-Agent ngẫu nhiên: {ua}")
    fp = get_fingerprint()
